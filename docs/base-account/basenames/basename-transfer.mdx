...
If you have an existing Basename you'd like to use, you'll need to transfer it to your new wallet address. We do not allow importing or linking of pre-existing Basenames without transfer at this time.
